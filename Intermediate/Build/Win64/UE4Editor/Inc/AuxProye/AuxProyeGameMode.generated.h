...
#ifdef AUXPROYE_AuxProyeGameMode_generated_h
#error "AuxProyeGameMode.generated.h already included, missing '#pragma once' in AuxProyeGameMode.h"
#endif
...
public: \
	DECLARE_CLASS(AAuxProyeGameMode, AGameModeBase, COMPILED_IN_FLAGS(0 | CLASS_Transient | CLASS_Config), CASTCLASS_None, TEXT("/Script/AuxProye"), AUXPROYE_API) \
...
#define AuxProye_Source_AuxProye_AuxProyeGameMode_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(AUXPROYE_API, AAuxProyeGameMode); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AAuxProyeGameMode); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	AUXPROYE_API AAuxProyeGameMode(AAuxProyeGameMode&&); \
	AUXPROYE_API AAuxProyeGameMode(const AAuxProyeGameMode&); \
public:
...
template<> AUXPROYE_API UClass* StaticClass<class AAuxProyeGameMode>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID AuxProye_Source_AuxProye_AuxProyeGameMode_h
